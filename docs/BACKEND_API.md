...
- `supabase/schema.sql` - The entire schema, preset categories and demo data.
  Run once in the Supabase SQL Editor. (This replaced a numbered migration
  chain that was internally inconsistent; see the Database section of the root
  README.)
